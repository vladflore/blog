...
Aah, yes, programming languages, you know, those languages you use to tell a computer what to do...there are plenty of them out there and it is my intention to learn them all...just kidding, ain't gonna do that, although it surely sounds appealing.

I personally started with Pascal, this was in high school, then continued with C, C++ and C++ - - a.k.a. Java, at the university. There were some other languages along the way, but in the end Java sticked to me and remained one of my to-go languages when I wanted to make my computer do something for me...and it also pays the bills, so yay Java.

Besides this, my appetite for other languages kind of grew bigger, and such I learned some Python, gave JavaScript another chance, started with Kotlin (I am using it at my current job), learned some Julia...and was getting very confused when I was switching from one language to another.
